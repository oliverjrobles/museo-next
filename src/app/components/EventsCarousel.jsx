...
export default function EventsCarousel() {
  ...
  const [itemsPerSlide, setItemsPerSlide] = useState(1); // 1 på mobil, 2 på desktop

  // Hent events (API + fallback)
  useEffect(() => {
    async function fetchEvents() {
      try {
        ...
        console.error("Kunne ikke hente events, bruger dummy-data", err);
        ...
        setEvents([
          {
            ...
            date: "25 Dec",
            time: "10:30 PM",
            location: "City Plaza, Newyork",
            imageUrl: "/assets/content-img/event-thumb1.jpg",
          },
          {
            id: 2,
            title: "Live Concert",
            description: "The best concert in town with amazing lights and sound.",
            date: "31 Dec",
            time: "10:30 PM",
            location: "Las Vegas, Nevada",
            imageUrl: "/assets/content-img/event-thumb2.jpg",
          },
          {
            id: 3,
            title: "Festival Night",
            description: "Join thousands of people dancing all night long.",
            date: "18 Dec",
            time: "09:00 PM",
            location: "Berlin, Germany",
            imageUrl: "/assets/content-img/event-thumb3.jpg",
          },
          {
            id: 4,
            title: "DJ Party",
            description: "Top DJs from around the world spinning the hottest tracks.",
            date: "20 Dec",
            time: "11:00 PM",
            location: "London, UK",
            imageUrl: "/assets/content-img/event-thumb4.jpg",
          },
          {
            id: 5,
            title: "Open Air Show",
            description: "Experience the magic of music under the open sky.",
            date: "22 Dec",
            time: "08:00 PM",
            location: "Barcelona, Spain",
            imageUrl: "/assets/content-img/event-thumb5.jpg",
          },
          {
            id: 6,
            title: "Club Vibes",
            description: "Non-stop party with live performances and special guests.",
            date: "28 Dec",
            time: "10:00 PM",
            location: "Paris, France",
            imageUrl: "/assets/content-img/event-thumb6.jpg",
          },
        ]);
      }
    }
  ...
  // Responsivt: 1 kort pr. slide på mobil, 2 på desktop
  useEffect(() => {
            ...
            <div key={slideIndex} className="min-w-full grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 p-2">
              {slideEvents.map((event) => (
                <article key={event.id} className="relative overflow-hidden rounded group cursor-pointer">
                  ...
                  {/* HOVER-OVERLAY (trekanter + CTA + tekstpanel) */}
